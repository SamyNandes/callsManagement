<!-------------------------------------------------------------------------
  ...
  Data: 15/12/2024
  Descrição: Estilização da página de login.
...
<template>
  <div class="container w-100 d-flex justify-content-center align-items-center"
    ...
    <div class="row w-50 h-70 shadow rounded p-5 d-flex flex-column align-items-center">
      <div class="d-flex flex-row justify-content-center m-3">
      ...
      </div>      <form class="d-flex flex-column align-items-center">
          <div class="inputs">
        ...
        <div class="inputs">
          <button class="btn btn-primary w-50" v-on:click="submitLoginInfos()">Login</button>
        </div>
    </div>
  </div>
</template>
